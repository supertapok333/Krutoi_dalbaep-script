...
-- Main Frame Setup (Height adjusted to 280)
...
-- Simple Teleport Button Setup (Height 35)
TpBtn.Parent = MainFrame
TpBtn.BackgroundColor3 = Color3.fromRGB(0, 120, 255) -- Nice blue color
TpBtn.Position = UDim2.new(0.1, 0, 0, 195)
TpBtn.Size = UDim2.new(0.8, 0, 0, 35)
TpBtn.Font = Enum.Font.SourceSansBold
TpBtn.Text = "TP TO TARGET"
...
TargetFlingBtn.Position = UDim2.new(0.1, 0, 0, 235)
